...
public class EnumLesson {
    public static void main(String[] args) {
        ...
        System.out.println(Operation.ADD.option + " " + Operation.ADD.apply(4, 8.5));
        System.out.println(Operation.SUBTRACT.option + " " + Operation.SUBTRACT.apply(4, 8.5));
        System.out.println(Operation.MULTIPLY.option + " " + Operation.MULTIPLY.apply(4, 8.5));
        System.out.println(Operation.DIVIDE.option + " " + Operation.DIVIDE.apply(4, 8.5));
        ...
        System.out.println("Статус заказа: " + OrderStatus.SHIPPED.status + (OrderStatus.SHIPPED.isCompleted()? " : завершен" : " : не завершен"));
